...
def get_photometry_data(context, target, target_share=False):
    ...
    for reduced_datum in photometry:
        rd_data = {'id': reduced_datum.pk,
                   ...
                   'magnitude_error': reduced_datum.value.get('error', '')
                   }

        # print(type(reduced_datum.value))
        #
        # print(reduced_datum.value)
        # print('magnitude' in reduced_datum.value)
        # print(reduced_datum.value['magnitude'])
        # print('magnitude' in reduced_datum)
        # print('magnitude' in reduced_datum.__dict__)
        # print('limit' in reduced_datum.__dict__)
        # print('model' in reduced_datum.__dict__)
        # print(reduced_datum.__dict__)
        # print(reduced_datum.columns)
        # print(reduced_datum.colnames)
        if 'limit' in reduced_datum.value.keys():
            rd_data['magnitude'] = reduced_datum.value['limit']
            rd_data['limit'] = True
        else:
