...
from tom_dataproducts.views import DataProductUploadView, DataProductFeatureView, UpdateReducedDataView, UpdateZTFView
...
urlpatterns = [
    ...
    path('data/reduced/update_ztf/', UpdateZTFView.as_view(), name='update-ZTF-data'),
